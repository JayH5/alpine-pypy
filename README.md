...
* In PyPy3.5 5.9.0, compilation of the `curses` module fails on platforms where `wint_t` != `int`. This has been fixed upstream already and we use [that patch](https://bitbucket.org/pypy/pypy/commits/8103736dfa9f32823d8659fab273613d5a1bc81f).
